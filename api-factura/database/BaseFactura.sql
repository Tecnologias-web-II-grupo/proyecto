...
CREATE TABLE portal_perfiles (
  ...
  bank_merchant_id VARCHAR(160) NULL,
  bank_afiliado BOOLEAN NOT NULL DEFAULT FALSE,
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE portal_ventas (
  ...
  bank_intent_id VARCHAR(100) NULL,
  ...
  UNIQUE KEY uq_portal_ventas_bank_payment (bank_payment_id),
  UNIQUE KEY uq_portal_ventas_bank_transaction (bank_transaction_code),
